...
public record UpdateOrganizationRecordCommand(
    Guid Id,
    ...
    [property: JsonPropertyName("business_full_address")] string BusinessFullAddress) : IRequest<OrganizationRecordDto?>;
