...
public class CreatePersonalRecordCommandHandler : IRequestHandler<CreatePersonalRecordCommand, Guid>
{
    private readonly IPersonalRecordRepository _repository;

    public CreatePersonalRecordCommandHandler(IPersonalRecordRepository repository)
    {
        _repository = repository;
    }

    public async Task<Guid> Handle(CreatePersonalRecordCommand request, CancellationToken cancellationToken)
    {
        var record = PersonalRecord.Create(
            request.HomeAddress,
            request.City,
